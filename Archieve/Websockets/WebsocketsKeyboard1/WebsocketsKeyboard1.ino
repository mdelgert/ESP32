/*
 * This code sets up a WebSocket client using the ArduinoWebsockets library, displays incoming messages on a TFT screen using the TFT_eSPI library, and sends keystrokes via USB HID Keyboard.
 * It includes:
 * - Initialization of the TFT display.
 * - Initialization of the WebSocket client.
 * - Initialization of the USB HID Keyboard.
 * - A function to print messages to the TFT screen and Serial Monitor based on flags.
 */
