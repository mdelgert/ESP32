...
// Amount to jiggle the mouse
const int JIGGLE_AMOUNT = 1;
const int JIGGLE_DELAY = 50;
const int JIGGLE_FLASH_DELAY = 500;

// Debugging control
const bool DEBUG_SERIAL = false; // Set to false to disable serial debugging
const bool DEBUG_TFT = true;    // Set to false to disable TFT output

// LED control
const bool ENABLE_LED = true;    // Set to false to disable LED
...
//const char* WEBSOCKETS_URL = "ws://192.168.0.2:5200/ws";
